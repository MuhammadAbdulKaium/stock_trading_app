            ...
            children: [
              ...
              Obx(() { 
                return TextInputField(
                  controller: personalController.fullNameController.value,
              ...
              Obx(() { 
                return TextInputField(
                  ...
                  validator: (value) {
                    ...
                    personalController.updateNidNumber;
              ...
              Obx(() { 
                return SizedBox(
                  ...
                  child: IntlPhoneField(
                    key: ValueKey(personalController.initialCountryCode.value), // Force rebuild on country code change
                    controller: personalController.phoneNumberController.value  ,
                    decoration: InputDecoration(
                      ...
                      errorBorder: OutlineInputBorder(
                        borderSide: const BorderSide(color: Color(0xFFB3261E), width: 1.0), // Border when error
                        borderRadius: BorderRadius.circular(8.0),
                      ),
                      focusedErrorBorder: OutlineInputBorder(
                        borderSide: const BorderSide(color: Color(0xFFB3261E), width: 1.0), // Border when focused and error
                        borderRadius: BorderRadius.circular(8.0),
                      ),
                      errorStyle: TextStyle(
                        fontSize: 10.3.sp,
                    ...
                    initialCountryCode: personalController.initialCountryCode.value, // Default country code
                    onChanged: (phone) {
              ...
              Obx(() { 
                return Row(
                  children: [
                    personalController.isPhoneNumberFieldEmpty.value ? Padding(
