          ...
          children: [
            ...
            Obx(() { 
              return TextInputField(
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: nomineeController.fullName.value,
                    selection: TextSelection.collapsed(offset: nomineeController.fullName.value.length),
                  ),
                ),
            ...
            Obx(() { 
              return TextInputField(
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: nomineeController.relationship.value,
                    selection: TextSelection.collapsed(offset: nomineeController.relationship.value.length),
                  ),
                ),
            ...
            Obx(() { 
              return TextInputField(
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: nomineeController.nidNumber.value,
                    selection: TextSelection.collapsed(offset: nomineeController.nidNumber.value.length),
                  ),
                ),
            ...
            Obx(() { 
              return TextInputField(
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: nomineeController.email.value,
                    selection: TextSelection.collapsed(offset: nomineeController.email.value.length),
                  ),
                ),
            ...
            SizedBox(
              ...
              child: IntlPhoneField(
                controller: nomineeController.phoneNumberController,
            ...
            Obx(() { 
              return TextInputField(
                controller: TextEditingController.fromValue(
                  TextEditingValue(
                    text: nomineeController.address.value,
                    selection: TextSelection.collapsed(offset: nomineeController.address.value.length),
                  ),
                ),
            ...
            SizedBox(
              ...
              child: Obx(() { 
                return CommonButton(
                  ...
                  ? () {
                    if (nomineeDetailsFormkey.currentState!.validate() && nomineeController.validateGender()) {
