...
class BankDetailsIncompleteDialog extends StatelessWidget {
  const BankDetailsIncompleteDialog({super.key});
      ...
      dialogContent: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Your Bank Details Incomplete! you need to fill up your bank info first to proceed.',
              textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 12.65.sp,
                fontFamily: 'Poppins',
                ...
                SizedBox(
                  ...
                  child: CommonButton(
                    ...
                    onPressed: () {
                      ...
                      landingPageController.profilePageTabController.value = 1;
