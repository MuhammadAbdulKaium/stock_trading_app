...
import 'package:stock_trading_app/mobile/investment_opportunity_details/investment_opportunity_basic_info.dart';

class InvestmentOpportunityDetailsPage extends StatelessWidget {
  const InvestmentOpportunityDetailsPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                    ...
                    alignment: Alignment.topCenter,
                      child: Column(
                        children: [
                          ...
                          const InvestmentOpportunityBasicInfo(),
                        ],
                      ),
                  ),
                ),
          ...
          Obx(() {
            return investmentOpportunityDetailsController.isLoading.value ? const CustomLoader() : const SizedBox.shrink();
          }),
        ],
      ),
    );
