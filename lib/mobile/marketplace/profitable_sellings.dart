      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              flex: 100,
              child: Obx(() => marketplaceController.profitableSellings.isEmpty
                ? Center(
                    child: Text(
                      'No item to show',
                      style: TextStyle(
                              ...
                              child: Row(
                                ...
                                children: [
                                        ...
                                        CircleAvatar(
                                          ...
                                          child: Center(
                                            child: SizedBox(
                                              ...
                                              child: profitableSell.imageUrl!.isNotEmpty && profitableSell.imageUrl != null
                                              ? Image.network(
                                                profitableSell.imageUrl!,
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: (profitableSell.status ?? false) ? const Color(0xFFDFFFEB) : const Color.fromARGB(255, 255, 223, 227),
                                      borderRadius: BorderRadius.circular(27),
                                    ),
                                    child: Text(
                                      (profitableSell.status ?? false) ? 'Active' : 'Inactive',
                                      style: TextStyle(
                                        fontSize: 11.5.sp,
                                        fontFamily: 'Gilroy',
                                        fontWeight: FontWeight.w600,
                                        color: (profitableSell.status ?? false) ? const Color(0xFF008037) : const Color.fromARGB(255, 128, 0, 38),
                                        overflow: TextOverflow.ellipsis,
                                      ),
                                    ),
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        'Purchase price (Per ${
                                          profitableSell.lotUnit!.isNotEmpty && profitableSell.lotUnit != null 
                                          ? profitableSell.lotUnit
                                          : 'Unit'
                                        }) :',
                                        style: TextStyle(
                                          fontSize: 12.5.sp,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            profitableSell.pricePerUnit?.toString() ?? '',
                                            style: TextStyle(
                                              fontSize: 12.5.sp,
                                              fontFamily: 'Gilroy',
                                              fontWeight: FontWeight.w600,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            profitableSell.transportCost?.toString() ?? '',
                                            style: TextStyle(
                                              fontSize: 12.5.sp,
                                              fontFamily: 'Gilroy',
                                              fontWeight: FontWeight.w600,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            profitableSell.handlingCost?.toString() ?? '',
                                            style: TextStyle(
                                              fontSize: 12.5.sp,
                                              fontFamily: 'Gilroy',
                                              fontWeight: FontWeight.w600,
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: CommonButton(
                                      ...
                                      onPressed: () {
                                        orderDetailsController.loadOrderDetailsPage(profitableSell.id!);
                                      },
                                    ),
                                  ),
                                ],
