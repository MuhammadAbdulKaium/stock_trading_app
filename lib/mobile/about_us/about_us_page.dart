...
import 'package:stock_trading_app/mobile/about_us/about_us_page_body.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Obx(() {
            return aboutUsController.isLoading.value ? const CustomLoader() : const SizedBox.shrink();
          }),
        ],
      ),
    );
