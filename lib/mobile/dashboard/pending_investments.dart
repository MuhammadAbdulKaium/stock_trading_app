          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Obx(() {
                  if (dashboardController.pendingInvestment.isEmpty) {
                    return Center(
                      child: Text(
                        'No Pending Investment found.',
                        style: TextStyle(
                          fontSize: 12.sp,
                          fontFamily: 'Gilroy',
                    ...
                    return Column(
                      children: dashboardController.pendingInvestment.map((investment) => 
                        Column(
                          children: [
                            Row(
                              children: [
                                                    ...
                                                    child: CircleAvatar(
                                                      ...
                                                      child: Center(
                                                        child: SizedBox(
                                                          ...
                                                          child: decideImageToShow(investment.productCategory!),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                            ...
                            if (dashboardController.pendingInvestment.indexOf(investment) != dashboardController.pendingInvestment.length - 1) 
