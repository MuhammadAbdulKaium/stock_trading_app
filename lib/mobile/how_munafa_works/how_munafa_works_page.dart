...
import 'package:stock_trading_app/mobile/how_munafa_works/how_munafa_works_page_body.dart';

class HowMunafaWorksPage extends StatelessWidget {
  const HowMunafaWorksPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Obx(() {
            return howMunafaWorksController.isLoading.value ? const CustomLoader() : const SizedBox.shrink();
          }),
        ],
      ),
    );
